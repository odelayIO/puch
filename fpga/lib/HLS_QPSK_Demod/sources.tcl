# Adding source code
add_files -norecurse ${DOCKER_BASE}/fpga/lib/HLS_QPSK_Demod/hw/qpsk_pkg.vhd
add_files -norecurse ${DOCKER_BASE}/fpga/lib/HLS_QPSK_Demod/hw/qpsk_reg.vhd
...
add_files -norecurse ${DOCKER_BASE}/fpga/lib/HLS_QPSK_Demod/src/QPSK_Demod_Top.vhd
...
set_property file_type {VHDL 2008} [get_files  ${DOCKER_BASE}/fpga/lib/HLS_QPSK_Demod/hw/qpsk_reg.vhd]
set_property file_type {VHDL 2008} [get_files  ${DOCKER_BASE}/fpga/lib/HLS_QPSK_Demod/hw/qpsk_pkg.vhd]
