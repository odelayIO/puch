...
--****
--****
--****    Auto Generated on Dec. 27, 2024 06:10:13 PM
--****
--***********************************************************************************************************
--***********************************************************************************************************
...
package Timestamp_Pkg is
  ...
  constant TS_DAY       : std_logic_vector(7 downto 0) := x"27";
  constant TS_HOUR      : std_logic_vector(7 downto 0) := x"18";
  constant TS_MIN       : std_logic_vector(7 downto 0) := x"10";
  constant TS_SEC       : std_logic_vector(7 downto 0) := x"13";
